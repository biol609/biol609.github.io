...
:::{.incremental}
- We are uninterested in *exogenous variable covariance*, but we control for it. 
- This does not preclude later assessing other relationships between *m* and *a*.
:::
...
$\beta_j \sim Normal(0, 100)$ [prior for each]{.fragment style="color:red"}   
$\sigma \sim Exp(1)$  
...
**Estimate total, direct, and indirect effect of Marriage Age on Divorce**
