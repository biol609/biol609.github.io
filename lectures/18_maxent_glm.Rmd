...
|------------|----------------|----------|
|Binomial | 1/4, 1/4, 1/4, 1/4  | `r entropy(rep(0.25,4))` |
|Candiate 1 | 2/6, 1/6, 1/6, 2/6 |  `r entropy(c(2/6, 1/6, 1/6, 2/6))` |
|Candiate 2 | 1/6, 2/6, 2/6, 1/6 |  `r entropy(c(1/6, 2/6, 2/6, 1/6))` |
|Candiate 3 | 1/8, 1/2, 1/8, 2/8 |  `r entropy(c(1/8, 1/2, 1/8, 2/8))` |
...
quants_unif <- qunif(ppoints(length(quants)))

#
plot(quants_unif, sort(quants))
abline(a=0, b=1)
```
