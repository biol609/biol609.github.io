...
To see the code of a lecture, load the slides, then change the file extension in your browser bar to .Rmd to get the code. Or go to [this link](https://github.com/biol609/biol609.github.io/tree/master/lectures) for all of the code.
  ...
  ### Week 1. 
__Lecture__: [Why Advanced Data Analysis?](lectures/01_intro.html), [Re-Introduction to Bayesian Logic](./lectures/11_bayes_reintro.html) and [Sampling](./lectures/12_posterior_sampling.html)  
...
### Week 5. 
__Lecture__: [GLM Review](lectures/02_generalized_linear_models.html), [MaxEnt and GLMs](./lectures/18_maxent_glm.html), Generalized Linear Models in a Bayesian Framework, [Overdispersed Models](./lectures/21_overdisp.html)    
__Reading:__ McElreath Chapter 9-10 
__Additional Readings:__ [O'Hara 2009](http://byrneslab.net/classes/biol609/O'Hara_2009_glmm.pdf) through section on GLMs, [O'Hara and Kotze 2010](http://byrneslab.net/classes/biol609/o'hara_and_kotze_do_not_log_transform.pdf), [Wharton and Hui 2011](http://byrneslab.net/classes/biol609/Wharton_Hui_2011_Ecology.pdf), [ver Hoef and Boveng 2007 on overdispersion](http://byrneslab.net/classes/biol609/Ver_Hoef_and_Boveng_qp_neg binomial.pdf), [Hartig DHARMa vignette](https://cran.r-project.org/web/packages/DHARMa/vignettes/DHARMa.html)  
__Files:__ [Data for GLM Lecture](lectures/02_data.zip)
__Etherpad:__ https://etherpad.wikimedia.org/p/609-glm-2019    


### Week 6. 
__Lecture:__ Zero Inflation, [Gamma and Zero Inflated Models](./lectures/20_zinfl.html), 
...
### Week 12. 
__Lecture:__ Meta-Analysis  
__Etherpad:__ https://etherpad.wikimedia.org/p/609-metaanalysis-2019  
...
### Week 15.  
__Final Presentations:__  
__Final Papers Due:__
