...
library(lubridate)
current_date = parse_date_time("2024-01-23", orders="ymd")
...
```
`r datestring`   
__Lecture:__ [Overdispersed Models](./lectures/overdisp.html), [Zero Inflated Models](./lectures/13_zinfl.html)   
...
```
`r datestring`   
__Lecture:__ [Dealing with Autocorrelation with Gaussian Proces Models and GAMs](./lectures/autocorr.html)     
...
```
`r datestring`   
__Lecture:__ [Measurement Error, Missing Data, and Bayesian Meta-Analysis ](lectures/missing_data_and_metaanalysis.html)    
...
```
`r datestring`   
__Lecture:__ [Working with advanced models](lab/missing_and_spatial_prediction.html), [Bayes Outside of Rethinking](lab/missing_and_spatial_prediction.html)  
